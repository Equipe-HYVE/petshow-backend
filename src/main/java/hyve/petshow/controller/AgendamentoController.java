...
public class AgendamentoController {
	...
	public ResponseEntity<AgendamentoRepresentation> adicionarAgendamento(
			@Parameter(description = "Agendamento que será inserido") @RequestBody AgendamentoRepresentation request)
			throws Exception {
	...
	public ResponseEntity<Page<AgendamentoRepresentation>> buscarAgendamentosPorCliente(
			@Parameter(description = "Id do cliente cujos agendamentos serão buscados") @PathVariable Long id,
			...
			throws Exception {
		var agendamentos = agendamentoService.buscarAgendamentosPorCliente(id,
				geraPageableOrdemMaisNovo(pagina, quantidadeItens));
	...
	public ResponseEntity<Page<AgendamentoRepresentation>> buscarAgendamentosPorPrestador(
			@Parameter(description = "Id do prestador cujos agendamentos serão buscados") @PathVariable Long id,
			@Parameter(description = "Número da página") @RequestParam("pagina") Integer pagina,
			@Parameter(description = "Número de itens") @RequestParam("quantidadeItens") Integer quantidadeItens)
			throws Exception {
		var agendamentos = agendamentoService.buscarAgendamentosPorPrestador(id,
				geraPageableOrdemMaisNovo(pagina, quantidadeItens));
		var representation = agendamentoConverter.toRepresentationPage(agendamentos);
	...
	public ResponseEntity<AgendamentoRepresentation> buscarAgendamentoPorId(
			...
			@Parameter(description = "Id do usuario que realiza a busca, para verificar se o mesmo pode ter acesso às informações") @PathVariable Long usuarioId)
			throws Exception {
	...
	public ResponseEntity<MensagemRepresentation> atualizarStatusAgendamento(
			@Parameter(description = "Id do agendamento") @PathVariable Long id,
			@Parameter(description = "Id do prestador responsável pelo agendamento") @PathVariable Long prestadorId,
			@Parameter(description = "Id do novo status do agendamento") @PathVariable Integer statusId)
	...
	public ResponseEntity<AvaliacaoRepresentation> adicionarAvaliacao(
			@Parameter(description = "Id do agendamento.") @PathVariable Long id,
			@Parameter(description = "Avaliação que será inserida") @RequestBody AvaliacaoRepresentation request)
			throws Exception {
	...
	public ResponseEntity<AvaliacaoRepresentation> buscarAvaliacaoPorAgendamento(
			@Parameter(description = "Id do agendamento.") @PathVariable Long id) throws Exception {
	...
	public ResponseEntity<List<String>> buscarHorariosAgendamento(
			...
			@Parameter(description = "Data do agendamento") @RequestParam("dataAgendamento") @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) LocalDate dataAgendamento) {
